...
pub fn create_chain() -> Chain {
    ...
    let router =
        router!(get_root: get "/" => handle_root,
                         ...
                         post_quiz_play_joker: post "/quiz/play/joker" => play::post_joker,
                         post_quiz_play_finish: post "/quiz/play/finish" => play::post_finish,
                         get_quiz_score: get "/quiz/score" => score::get_score,
                         post_quiz_score_remove: post "/quiz/score/remove" => score::post_score_remove,
